...
export default async function DocPage({ params, searchParams }: {
  params: { classroom: string, semester: string, subject: string, id: string },
  ...
  const downloadHref = `/c/${params.classroom}/s/${params.semester}/${params.subject}/doc/${doc.id}/download${searchParams.token ? `?token=${searchParams.token}` : ''}`
